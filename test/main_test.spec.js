...
describe('phoneNumber() Returns a phone number formated for a \'<a href="tel:" />\' link', function() {
  ...
  it('should invalidate 11-digit numbers that don\'t begin with 1', function() {
  ...
  it('should invalidate when more than 11 digits', function() {
    expect(phoneNumber('321321321321')).to.be.null
  })
  it('should invalidate when letters and/or punctuation are present', function() {
    expect(phoneNumber('abc-a@c-abcd')).to.be.null
  })
  it('should invalidate when area code does not start with 2-9', function() {
    expect(phoneNumber('021-321-4321')).to.be.null
  })
  it('should invalidate when exchage code does not start with 2-9', function() {
